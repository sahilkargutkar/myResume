...
const InfoSection = ({lightBg,imgStart,topLine,headline,description,buttonLabel,img,alt,id,lightText,darkText
                        ,primary,dark,dark2 }) => {
    return (
        <>
              ...
              <InfoWrapper >
                <InfoRow imgStart={imgStart}>
                    ...
                    <TopLine>{topLine}</TopLine>
                        ...
                        <BtnWrap>
                            <Button to='contactme' smooth={true} duration={500} spy={true}
